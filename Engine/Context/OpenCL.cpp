...
//#include "OpenCL.h"
//
//using namespace Kiwi::Engine::Context; //todo normally I never do that but man those namespaces
//
...
//    error.append(": ");
//    std::cerr << error + caller << std::endl;
//}
//
...
//
//void
//OpenCL::CreateKernelFromFile(const char *filename, const char *kernel_name) {
...
//
//void
//OpenCL::CreateKernels(std::vector<const char *> kernel_name)
//{
...
//
//void
//OpenCL::CreateKernelFromProgram(const char *kernel_name)
//{
//    cl_kernel kernel;
//    kernel = clCreateKernel(_program, kernel_name, &_status);
//    STATUS("clCreateKernel");
...
//
//cl_mem
//OpenCL::CreateBufferFromVBO(cl_GLuint vbo, cl_mem_flags permission)
//{
...
//
//cl_mem
//OpenCL::CreateBuffer(size_t size, cl_mem_flags permission, void *host_ptr) {
...
//OpenCL::getQueue() const {
//    return _queue;
//}
//
//const void
//OpenCL::getStatus(cl_int status, const char *caller) {
//    cl_checkStatus(status, caller);
//}
//
//const cl_kernel
//OpenCL::getKernel(std::string kernel) const {
